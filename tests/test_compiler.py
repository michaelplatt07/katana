...
class TestCompilerInt:
    ...
    def test_int_declared_from_expression_addition(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_int_from_expression_addition.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert compiler.variables == {
    ...
    def test_int_declared_from_expression_subtraction(self):
        ...
        with open(
            curr_dir
            + "/tests/test_programs/sample_int_from_expression_subtraction.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert compiler.variables == {
    ...
    def test_assign_new_value_int(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_assign_new_value_to_int.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert compiler.variables == {
    ...
    def test_set_var_to_another_var(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_set_var_to_another.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
...
class TestCompilerString:
    ...
    @pytest.mark.skip
    def test_conctenate_char_to_string(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_string_concatenation.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert compiler.variables == {
    ...
    def test_assign_new_value_string(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_assign_new_value_to_string.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert compiler.variables == {
...
class TestCompilerChar:
    ...
    def test_assign_new_value_char(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_assign_new_value_to_char.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert compiler.variables == {
...
class TestCompilerBool:
    ...
    def test_bool_true_keyword_assignment(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_bool_true_assignment.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert compiler.variables == {
...
class TestCompilerIfElse:
    ...
    def test_if_keyword(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_conditional_if_only.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_if_else_keyword_with_less_than(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_conditional_if_else_less_than.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_if_else_keyword_with_equal(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_conditional_if_else_equal.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
...
class TestCompilerLoop:
    ...
    def test_loop_from_ascending(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_from_ascending.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_from_descending(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_from_descending.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_up_and_down_not_nested(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_up_down_not_nested.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_up_and_down_nested(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_up_and_down_nested.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_down_with_vars(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_down_with_vars.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_from_with_var_first_param(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_from_with_var_first_param.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_from_with_var_second_param(self):
        ...
        with open(
            curr_dir
            + "/tests/test_programs/sample_loop_from_with_var_second_param.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
...
class TestCompilerLoopIdx:
    ...
    def test_loop_up(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_up_access_index.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_down(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_down_access_index.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_from(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_from_access_index.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
...
class TestCompilerLoopInclusive:
    ...
    def test_loop_down_inclusive(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_down_inclusive.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_from_inclusive_ascending(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_from_inclusive_ascending.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
    ...
    def test_loop_from_inclusive_descending(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_loop_from_inclusive_descending.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
            assert assembly == [
...
class TestCompilerMultipleVarDeclarations:
    def test_multiple_var_type_declarations(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_multi_var_type_declaration.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
...
class TestCompilerMacroKeyword:
    ...
    def test_macro_successfully_used(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_macro_replaces_successfully.ktna"
        ) as f:
            assembly = get_assembly_for_program(f.readlines())
            assert assembly == [
                "    ;; Push a raw string and length onto stack\n",
    ...
    def test_macro_successfully_used_more_than_once(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_macro_multiple_uses.ktna"
        ) as f:
            assembly = get_assembly_for_program(f.readlines())
            assert assembly == [
                "    ;; Push a raw string and length onto stack\n",
...
class TestCompilerFunctions:
    ...
    def test_function_successfully_declared_and_used(self):
        curr_dir = os.getcwd()
        with open(
            curr_dir + "/tests/test_programs/sample_fn_declaration_and_use.ktna"
        ) as f:
            compiler = get_compiler_class(f.readlines())
            assembly = compiler.get_assembly()
