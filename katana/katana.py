...
##############
ALL_TOKENS = (
    TokenType.COMMENT_TOKEN_TYPE,
    TokenType.DIVIDE_TOKEN_TYPE,
    TokenType.MINUS_TOKEN_TYPE,
    TokenType.MULTIPLY_TOKEN_TYPE,
    TokenType.NUM_TOKEN_TYPE,
    TokenType.NEW_LINE_TOKEN_TYPE,
    TokenType.PLUS_TOKEN_TYPE,
    TokenType.LEFT_PAREN_TOKEN_TYPE,
    TokenType.RIGHT_PAREN_TOKEN_TYPE,
    TokenType.SPACE_TOKEN_TYPE,
    TokenType.EOL_TOKEN_TYPE,
    TokenType.EOF_TOKEN_TYPE
)
IGNORE_TOKENS = (TokenType.SPACE_TOKEN_TYPE,)
IGNORE_OPS = (
    TokenType.SPACE_TOKEN_TYPE,
    TokenType.COMMENT_TOKEN_TYPE,
    TokenType.NEW_LINE_TOKEN_TYPE,
